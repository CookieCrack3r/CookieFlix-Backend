...
ALLOWED_HOSTS = [
    ...
    'http://127.0.0.1',
    '127.0.0.1',
    'cookieflix2.martinfriedrich.org',
    'https://cookieflix.martinfriedrich.org',
    'https://cookieflix2.martinfriedrich.org',
    'http://cookieflix.martinfriedrich.org',
    'http://cookieflix2.martinfriedrich.org',
]
...
DOMAIN = os.getenv('DOMAIN', 'localhost:8002')
